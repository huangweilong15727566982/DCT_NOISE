...
parser.add_argument('--eval_batch_size', default=64, type=int, help='perturb step size')
...
def main():
    model=mlconfig.getcls(config.model)(num_classes=config.num_classes).to(device)
    print(model)
    datasets_generator = mlconfig.getcls(config.dataset)(train_data_type=args.train_data_type,
